...
This directory contains structured learning plans, resources, and progress tracking for ongoing education and skill development.

## Topics & Progress

### Tech
- [ ] [IP Networking](Tech/Ip-networking/)
- [ ] [Vlans](Tech/Vlans/)
- [ ] [Managed Switches](Tech/Managed-switches/)
- [ ] [Qos](Tech/Qos/)
...
- [ ] [WSM](Software/WSM/)
- [ ] [Arraycalc](Software/Arraycalc/)
- [ ] [R1](Software/R1/)
- [ ] [Vs Code](Software/Vs-Code/)
- [ ] [REW](Software/REW/)
- [ ] [SMAART](Software/SMAART/)
...
- [ ] [Power Diagrams](Paperwork/Power-diagrams/)
- [ ] [Rack Diagrams](Paperwork/Rack-diagrams/)
- [ ] [Timesheets](Paperwork/Timesheets/)
